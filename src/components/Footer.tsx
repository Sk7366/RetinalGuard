      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          ...
          <div className="space-y-3 text-xs">
            ...
            <ul className="space-y-2 text-[#827477]">
              <li className="flex items-center gap-1.5 text-[#A39699]">
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-[#2E282B] flex flex-col sm:flex-row items-center justify-between text-xs text-[#827477] gap-4">
