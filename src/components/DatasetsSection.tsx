  ...
  return (
    <section className="bg-white rounded-2xl border border-[#EFE4DC] p-6 sm:p-10 shadow-xs space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* FUNDUS DATASETS */}
        <div className="p-5 rounded-xl border border-[#FED7AA] bg-[#FFFDF9] space-y-4">
          ...
          <div className="space-y-3 text-xs">
            <div className="p-3 bg-white rounded-lg border border-[#EFE4DC]">
              <div className="flex justify-between font-bold text-[#2B2024]">
                <span>APTOS 2019 Blindness</span>
                <span className="font-mono text-[#F05A28]">3,662 scans</span>
              </div>
            ...
            <div className="p-3 bg-white rounded-lg border border-[#EFE4DC]">
              <div className="flex justify-between font-bold text-[#2B2024]">
                ...
                <span className="font-mono text-[#F05A28]">88,702 scans</span>
              </div>
              <p className="text-[11px] text-[#6F6267] mt-0.5">
            ...
            <div className="p-3 bg-white rounded-lg border border-[#EFE4DC]">
              <div className="flex justify-between font-bold text-[#2B2024]">
                ...
                <span className="font-mono text-[#F05A28]">2,264 scans</span>
              </div>
              <p className="text-[11px] text-[#6F6267] mt-0.5">
        ...
        {/* OCT DATASETS */}
        <div className="p-5 rounded-xl border border-[#FBCFE8] bg-[#FFFDF9] space-y-4">
        ...
        {/* CLINICAL METADATA */}
        <div className="p-5 rounded-xl border border-[#EFE4DC] bg-[#FFFDF9] space-y-4">
          ...
          <div className="space-y-3 text-xs">
            <div className="p-3 bg-white rounded-lg border border-[#EFE4DC]">
              <div className="flex justify-between font-bold text-[#2B2024]">
                ...
                <span className="font-mono text-[#F05A28]">10,000 synthetic rows</span>
              </div>
              <p className="text-[11px] text-[#6F6267] mt-0.5">
            ...
            <div className="p-3 bg-white rounded-lg border border-[#EFE4DC]">
              <div className="flex justify-between font-bold text-[#2B2024]">
                ...
                <span className="font-mono text-[#F05A28]">10 features</span>
              </div>
              <p className="text-[11px] text-[#6F6267] mt-0.5">
            ...
            <div className="p-3 bg-white rounded-lg border border-[#EFE4DC]">
              <div className="flex justify-between font-bold text-[#2B2024]">
                ...
                <span className="font-mono text-[#F05A28]">Local attributions</span>
              </div>
              <p className="text-[11px] text-[#6F6267] mt-0.5">
      ...
      <div className="p-4 rounded-xl bg-[#FFE5D8] border border-[#FED7AA] text-xs text-[#D84818] flex items-start gap-3">
