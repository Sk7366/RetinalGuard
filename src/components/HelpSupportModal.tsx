      ...
      >
        ...
        <div className="bg-[#FFFDF9] border-b border-[#EFE4DC] px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-[#FFE5D8] border border-[#FED7AA] flex items-center justify-center text-[#F05A28]">
              <HelpCircle className="w-5 h-5" />
            </div>
            <div>
              <h2 id="help-modal-title" className="text-base sm:text-lg font-serif font-bold text-[#2B2024]">
          ...
          <button
            type="button"
            onClick={onClose}
            className="w-8 h-8 rounded-lg text-[#9E8D91] hover:text-[#2B2024] hover:bg-[#FFFDF9] flex items-center justify-center transition-colors"
        ...
        <div className="p-6 overflow-y-auto space-y-6">
          ...
          {activeTab === 'patient' && (
            <div className="space-y-4">
              <div className="p-4 rounded-xl bg-[#FFE5D8] border border-[#FED7AA] flex items-start gap-3">
                <ShieldCheck className="w-5 h-5 text-[#F05A28] flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="text-sm font-bold text-[#D84818]">{t('painlessCheckTitle', 'Eye Screening is 100% Painless')}</h4>
                  <p className="text-xs text-[#B83A12] mt-0.5 leading-relaxed">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="p-4 rounded-xl border border-[#EFE4DC] bg-[#FFFDF9] space-y-2">
                  <h5 className="text-xs font-bold text-[#2B2024]">{t('whatIfChangesTitle', 'What if my photo shows changes?')}</h5>
                ...
                <div className="p-4 rounded-xl border border-[#EFE4DC] bg-[#FFFDF9] space-y-2">
                  <h5 className="text-xs font-bold text-[#2B2024]">{t('howOftenCheckTitle', 'How often should I get checked?')}</h5>
                  <p className="text-xs text-[#6F6267] leading-relaxed">
              ...
              <div className="p-4 rounded-xl border border-[#EFE4DC] flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white">
                <div>
                  <h5 className="text-xs font-bold text-[#2B2024]">{t('needHelpCampTitle', 'Need help finding a nearby eye camp?')}</h5>
                  <p className="text-[11px] text-[#6F6267]">{t('needHelpCampDesc', 'Our team operates free screening in community health centers.')}</p>
                </div>
                {onNavigate && (
                  <button
                    type="button"
                    ...
                    className="px-4 py-2 rounded-lg bg-[#F05A28] text-white text-xs font-semibold hover:bg-[#D84818] transition-colors whitespace-nowrap"
                  >
          ...
          {activeTab === 'helper' && (
            <div className="space-y-4">
              <div className="p-4 rounded-xl bg-[#FFFDF9] border border-[#EFE4DC] space-y-2">
                <h4 className="text-xs font-bold text-[#2B2024] flex items-center gap-2">
                  <Camera className="w-4 h-4 text-[#F05A28]" />
                  <span>{t('fundusCaptureSOPTitle', 'Standard Non-Mydriatic Fundus Capture SOP')}</span>
                </h4>
                <ul className="text-xs text-[#6F6267] space-y-1.5 list-disc list-inside">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="p-3.5 rounded-xl border border-[#EFE4DC] bg-white space-y-1">
                  <span className="text-xs font-bold text-[#2B2024]">{t('campModeOfflineTitle', 'Camp Mode Offline Sync')}</span>
                ...
                <div className="p-3.5 rounded-xl border border-[#EFE4DC] bg-white space-y-1">
                  <span className="text-xs font-bold text-[#2B2024]">{t('referralProtocolTitle', 'Referral Escalation Protocol')}</span>
                  <p className="text-[11px] text-[#6F6267] leading-relaxed">
              ...
              <div className="p-4 rounded-xl bg-[#FFFDF9] border border-[#EFE4DC] space-y-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-2">
                  <div className="p-2.5 rounded-lg bg-white border border-[#EFE4DC] text-center">
                    ...
                    <span className="text-sm font-mono font-bold text-[#F05A28]">0.942</span>
                  </div>
                  <div className="p-2.5 rounded-lg bg-white border border-[#EFE4DC] text-center">
                    <span className="text-[10px] text-[#9E8D91] block">{t('multiclassQwk', 'Multi-class QWK')}</span>
                    <span className="text-sm font-mono font-bold text-[#F05A28]">0.884</span>
                  </div>
                  <div className="p-2.5 rounded-lg bg-white border border-[#EFE4DC] text-center">
                    <span className="text-[10px] text-[#9E8D91] block">{t('severePdrSens', 'Severe PDR Sens')}</span>
                    <span className="text-sm font-mono font-bold text-[#F05A28]">94.1%</span>
                  </div>
                  <div className="p-2.5 rounded-lg bg-white border border-[#EFE4DC] text-center">
                    <span className="text-[10px] text-[#9E8D91] block">{t('cpuLatency', 'CPU Latency')}</span>
                    <span className="text-sm font-mono font-bold text-[#F05A28]">42ms</span>
                  </div>
                </div>
              </div>

              <div className="p-3.5 rounded-xl border border-[#EFE4DC] bg-white space-y-1">
                <span className="text-xs font-bold text-[#2B2024]">{t('statisticalSignificanceTitle', 'Statistical Significance')}</span>
                <p className="text-[11px] text-[#6F6267] leading-relaxed">
        ...
        {/* MODAL FOOTER */}
        <div className="bg-[#FFFDF9] border-t border-[#EFE4DC] px-6 py-3 flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-1.5 rounded-lg bg-[#2B2024] text-white text-xs font-medium hover:bg-stone-800 transition-colors"
          >
            {t('doneBtn', 'Done')}
          </button>
        </div>
